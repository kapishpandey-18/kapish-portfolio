  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-slate-900 rounded-lg p-6 w-[min(560px,92%)] border border-neutral-800">
        ...
        <p className="text-sm text-neutral-400 mb-3">Choose a square image (PNG/JPEG). The image is stored locally in your browser.</p>
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="flex-1">
            ...
            <div className="mt-4 flex gap-2">
              <button onClick={save} disabled={!preview} className="rounded-md bg-blue-500 px-4 py-2 text-white disabled:opacity-50">Save</button>
              <button onClick={remove} className="rounded-md border border-neutral-700 px-4 py-2 text-neutral-300">Remove</button>
              <button onClick={onClose} className="rounded-md border border-neutral-700 px-4 py-2 text-neutral-300">Cancel</button>
            </div>
          </div>
        </div>
      </div>
